<div class="card mb-2">
    @if ($successes->contains('challenge_id', 4))
        <div class="card-body">
            <h4 class="card-title">SQL Injection</h4>
            <p class="card-text">Use SQL injection to login with the default administrator account.</p>
        </div>
    ...
    @else
        ...
        <form class="form-inline card-footer" action="{{route('challenges.attempt')}}" method="POST">
            ...
            <div class="form-inline my-1 mr-sm-2">
                ...
                <input type="hidden" class="form-control" name="challenge_id" id="challenge_id" value="4">
